...
String|[Why strings are immutable in Java?](Why strings are immutable in Java?)|
...
LinkedList|[Can we reverse a linked list in less than O(n) ?](Can we reverse a linked list in less than O(n) ?)|
LinkedList|[Why Quicksort is preferred for. Arrays and Merge Sort for LinkedLists ?](Why Quicksort is preferred for. Arrays and Merge Sort for LinkedLists ?)|
